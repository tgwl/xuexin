...
const menuList = [
 ...
 { id: 'logout-account', title: '注销账号', icon: 'mdi:account-remove-outline', route: '/account' }
];
...
.header {
  background-color: #fff;
  padding: 2px 16px 8px; /* 上边距改为 2px，更贴近状态栏 */
  border-bottom: 1px solid #ebedf0;
  height: 34px; /* 可选：固定高度 */
  display: flex;
  align-items: flex-start; /* 让内容贴顶 */
}
.title {
  font-size: 18px;
  font-weight: 500;
  ...
  flex: 1;
  text-align: center;
  line-height: 1; /* 关键：让文字不被行高撑开 */
  padding-top: 0; /* 确保无额外顶部内边距 */
}
